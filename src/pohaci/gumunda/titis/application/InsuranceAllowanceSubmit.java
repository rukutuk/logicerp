...
public class InsuranceAllowanceSubmit {
       
  public InsuranceAllowanceSubmit(boolean cekExcel) {
	 
	//int no = 0;
    try {
      String filename = "rptInsuranceAllowanceSubmit.jrxml";          
      if(filename.equals(""))
        return;      
      ...
      if(cekExcel){
        ...
        view.setTitle("Insurance Allowences Submit");
