 ...
 *
 */
public class PmtOthersDBUtilFrame extends JFrame {
	...
	private void updateTableStructure() {
		PmtOthersSQLUtil sqlUtil = new PmtOthersSQLUtil(connection);
		...
		try {
			if (sqlUtil.ifTotalColumnExists()) {
				...
				EventTableModel tableModel = new EventTableModel(
						filterList, new PmtOthersTableFormat());
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				PmtOthersDBUtilFrame thisClass = new PmtOthersDBUtilFrame();
