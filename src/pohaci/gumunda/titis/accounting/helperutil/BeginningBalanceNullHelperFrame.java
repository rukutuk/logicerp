 ...
 *
 */
public class BeginningBalanceNullHelperFrame extends JFrame {
	...
	private void setViewer() {
		...
		BeginningBalanceNullHelperViewerCreator creator =
			new BeginningBalanceNullHelperViewerCreator(connection, getDatePicker().getDate());
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				BeginningBalanceNullHelperFrame thisClass = new BeginningBalanceNullHelperFrame();
	 ...
	 */
	public BeginningBalanceNullHelperFrame() {
		super();
		initializeDB();
		initialize();
	}
