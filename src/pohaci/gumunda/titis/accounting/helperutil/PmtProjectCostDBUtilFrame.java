 ...
 *
 */
public class PmtProjectCostDBUtilFrame extends JFrame {
	...
	private void updateTableStructure() {
		PmtProjectCostSQLUtil sqlUtil = new PmtProjectCostSQLUtil(connection);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				PmtProjectCostDBUtilFrame thisClass = new PmtProjectCostDBUtilFrame();
	 ...
	 */
	public PmtProjectCostDBUtilFrame() {
		super();
		initialize();
		initDB();
