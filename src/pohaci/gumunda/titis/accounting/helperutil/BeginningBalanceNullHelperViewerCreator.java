 ...
 *
 */
public class BeginningBalanceNullHelperViewerCreator {
	 ...
	 * @param connection
	 */
	public BeginningBalanceNullHelperViewerCreator(Connection connection, Date date) {
	...
	private void setViewer(Date date) {
		...
		try {
			...
			if (connection != null) {
				if (date != null) {
					BeginningBalanceNullLogic logic = new BeginningBalanceNullLogic();
