 ...
 *
 */
public class PmtOperationalCostDBUtilFrame extends JFrame {
	...
	private void updateTableStructure() {
		PmtOperationalCostSQLUtil sqlUtil = new PmtOperationalCostSQLUtil(connection);
		...
		try {
			if (sqlUtil.ifTotalColumnExists()) {
				...
				EventTableModel tableModel = new EventTableModel(
						filterList, new PmtOperationalCostTableFormat());
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				PmtOperationalCostDBUtilFrame thisClass = new PmtOperationalCostDBUtilFrame();
	 ...
	 */
	public PmtOperationalCostDBUtilFrame() {
		super();
		initialize();
		initDB();
	...
	private void initialize() {
		...
		this.setTitle("Payment Operational Cost DBUtil");
	}
