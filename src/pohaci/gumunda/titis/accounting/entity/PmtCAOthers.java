...
public class PmtCAOthers extends TransactionTemplateEntity implements GeneralVoucher{
	long index ;
	...
	public void submit(long sessionId,java.sql.Connection conn) throws Exception {
		...
		VariableAccountSetting vas = 
			VariableAccountSetting.createVariableAccountSetting(conn, sessionId, IConstants.ATTR_VARS_CA_OTHER);
