...
public class TesMemJournalNonStrdDet extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(MemJournalNonStrdDet.class);	
		MasterMap.setPrimaryConnection(connection);
		MemJournalNonStrdDet o =
			new MemJournalNonStrdDet();		
		...
		MemJournalNonStrdDet obaru = (MemJournalNonStrdDet) list.get(0);		
