...
public class TesPayrollPmtTax21Ho extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(PayrollPmtTax21Ho.class);	
		MasterMap.setPrimaryConnection(connection);
		PayrollPmtTax21Ho o =
			new PayrollPmtTax21Ho();
		...
		PayrollPmtTax21Ho obaru = (PayrollPmtTax21Ho) list.get(0);
