...
public class TesPmtCAIOUOthersInstall extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(PmtCAIOUOthersInstall.class);	
		MasterMap.setPrimaryConnection(connection);
		PmtCAIOUOthersInstall o =
			new PmtCAIOUOthersInstall();
		...
		PmtCAIOUOthersInstall obaru = (PmtCAIOUOthersInstall) list.get(0);
