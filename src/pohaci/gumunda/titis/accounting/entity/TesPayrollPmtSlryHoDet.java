...
public class TesPayrollPmtSlryHoDet extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(PayrollPmtSlryHoDet.class);	
		MasterMap.setPrimaryConnection(connection);
		PayrollPmtSlryHoDet o =
			new PayrollPmtSlryHoDet();
		...
		PayrollPmtSlryHoDet obaru = (PayrollPmtSlryHoDet) list.get(0);	
