...
public class PayrollPmtTax21Ho extends TransactionTemplateEntity implements GeneralVoucher,GeneralJasperVchr_Salary{	
	long m_index;
	//Transaction m_trans;	
	//Date m_submitDate;
	...
	PayrollPmtTax21HoDet[] payrollPmtTax21HoDet;
	public PayrollPmtTax21Ho(){
	...
	public Object vgetVoucherType() {
		return "Tax Art 21 Payment - Head Office";
	}
	...
	public Object vgetUnitCode() {
		if (unit!=null)
			return this.unit.m_code + " " + unit.getDescription();
		return "";
	}
	...
	public PayrollPmtTax21HoDet[] getPayrollPmtTax21HoDet() {
		return payrollPmtTax21HoDet;
	}
	public void setPayrollPmtTax21HoDet(PayrollPmtTax21HoDet[] payrollPmtTax21HoDet) {
		this.payrollPmtTax21HoDet = payrollPmtTax21HoDet;
	}
	...
	public void submit(long sessionId,java.sql.Connection conn) throws Exception {
		...
		PayrollPmtTax21HoDet[] dets = getPayrollPmtTax21HoDet();
		double amount = 0;
		...
		List journalStdList = 
			helper.getJournalStandardSettingWithAccount(
					IConstants.PAYROLL_PAYMENT_TAX21_HO, attr);
