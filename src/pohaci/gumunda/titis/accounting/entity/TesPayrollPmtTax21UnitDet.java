...
public class TesPayrollPmtTax21UnitDet extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(PayrollPmtTax21UnitDet.class);	
		MasterMap.setPrimaryConnection(connection);
		PayrollPmtTax21UnitDet o =
			new PayrollPmtTax21UnitDet();	
		...
		PayrollPmtTax21UnitDet obaru = (PayrollPmtTax21UnitDet) list.get(0);
