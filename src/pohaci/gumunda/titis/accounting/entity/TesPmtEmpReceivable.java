...
public class TesPmtEmpReceivable extends TestCase {
	public void testInsert() throws Exception
	{
		...
		GenericMapper m = MasterMap.obtainMapperFor(PmtEmpReceivable.class);	
		MasterMap.setPrimaryConnection(connection);
		PmtEmpReceivable o =
			new PmtEmpReceivable();
		...
		PmtEmpReceivable obaru = (PmtEmpReceivable) list.get(0);
