...
public class ReportCreatorDlg extends JDialog implements ActionListener {
  /**
	 * 
	 */
...
Connection m_conn = null;
  ...
  public ReportCreatorDlg(JFrame owner, Connection conn, long sessionid) {
    super(owner, "Add Report", true);
    setSize(300, 120);
    m_mainframe = owner;
    m_conn = conn;
  ...
  void constructComponent() {
    ...
    centerPanel.add(new JLabel("Report Name"), gridBagConstraints);
  ...
  void save() {
    ...
    try {
      ...
      m_report = logic.createBalanceSheetReport(m_sessionid, IDBConstants.MODUL_MASTER_DATA, new Report(name));
    }
    catch(Exception ex) {
