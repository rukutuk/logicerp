...
public class WorksheetColumnCreatorDlg extends JDialog implements ActionListener {
  /**
	 * 
	 */
...
Connection m_conn = null;
  ...
  WorksheetColumn m_column = null;

  public WorksheetColumnCreatorDlg(JFrame owner, Connection conn, long sessionid, Worksheet worksheet) {
    super(owner, "Add Woksheet Column", true);
    setSize(300, 120);
    m_mainframe = owner;
    m_conn = conn;
  ...
  void constructComponent() {
    ...
    centerPanel.add(new JLabel("Column Name"), gridBagConstraints);
  ...
  void save() {
    ...
    try {
      ...
      m_column = logic.createWorksheetColumn(m_sessionid, IDBConstants.MODUL_MASTER_DATA, m_worksheet.getIndex(),
          new WorksheetColumn(name));
    }
    catch(Exception ex) {
  ...
  public WorksheetColumn getWorksheetColumn() {
    return m_column;
  }
