...
public class SearchVoucherFrame extends JDialog implements ActionListener {
	/**
	 *
	 */
	...
	public SearchVoucherFrame(JFrame owner, String title, Connection conn, long sessionid, VoucherLoader loader){
		//super(( title == null ) ? "Search Voucher" : title);
	...
	public SearchVoucherFrame(JFrame owner, String title, Connection conn, long sessionid, VoucherLoader loader,String type){
		//super(( title == null ) ? "Search Voucher" : title);
		super(owner, ( title == null ) ? "Search Voucher" : title, true);
		this.loader = loader;
