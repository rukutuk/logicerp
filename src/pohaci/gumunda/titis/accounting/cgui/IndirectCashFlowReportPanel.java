 ...
 *
 */
public class IndirectCashFlowReportPanel extends JPanel {
	...
	public IndirectCashFlowReportPanel(Connection connection, long sessionId) {
		super();
	...
	private void initDesignList() {
		...
		IndirectCashFlowStatementDesign[] designs = (IndirectCashFlowStatementDesign[]) list
				.toArray(new IndirectCashFlowStatementDesign[list.size()]);
	...
	private JRViewer getReport() {
		if (report == null) {
			IndirectCashFlowReport stmt = new IndirectCashFlowReport();
	...
	private void revalidateReport(IndirectCashFlowStatementReportContext context, IndirectCashFlowStatementDesign design) {
		...
		IndirectCashFlowReport stmt = new IndirectCashFlowReport(context, design, connection, m_excel);
