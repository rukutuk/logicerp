 ...
 *
 */
public class IndirectCashFlowReport {
	JRViewer viewer;

	private ReportContext context = null;

	private IndirectCashFlowStatementDesign design = null;
	...
	public IndirectCashFlowReport() {
		setJasper();
	}

	public IndirectCashFlowReport(ReportContext context, IndirectCashFlowStatementDesign design, Connection connection, boolean excel) {
