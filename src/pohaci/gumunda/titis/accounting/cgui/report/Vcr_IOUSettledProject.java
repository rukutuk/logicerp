...
public class Vcr_IOUSettledProject {
	public Vcr_IOUSettledProject(JDialog owner,PmtCAIOUProject entityParent,PmtCAIOUProjectSettled entity){
		try {      
			String filename = "Vchr_IOUSettledProject.jrxml";
			...
			if (entity.getChequeduedate()!=null)
				parameters.put("param_duo_date",dateFormat.format(entity.getChequeduedate()));
			else
				parameters.put("param_duo_date","");
			...
			parameters.put("param_transaction_type","Cash Advance - I Owe U Project Payment");
			...
			model.addRow(new Object[]{"1", entity.getDescription(),
					entity.getCurrency().getSymbol() + " " + desimalFormat.format(entity.getAmount()), new Integer(1)});
