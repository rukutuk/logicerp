...
public class Rcpt_IOUSettledProject {
	public Rcpt_IOUSettledProject(JDialog owner,PmtCAIOUProject entityParent,PmtCAIOUProjectReceive entity){
		try {      
			String filename = "Rcpt_IOUSettledProject.jrxml";
			...
			String recFrom = entityParent.getPayTo().getFirstName() + " " + entityParent.getPayTo().getMidleName() + 
			" " + entityParent.getPayTo().getLastName();
			parameters.put("param_receive_from", recFrom);			
			...
			parameters.put("param_transaction_type","I Owe U - Project Settled  Receive");
			...
			view.setTitle("I Owe You Project Settled Receipt");
