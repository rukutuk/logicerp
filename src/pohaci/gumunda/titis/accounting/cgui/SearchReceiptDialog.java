...
import pohaci.gumunda.titis.accounting.entity.GeneralReceipt;
import pohaci.gumunda.titis.accounting.entity.ReceiverLoader;
import pohaci.gumunda.titis.hrm.cgui.EmployeeCellEditor;

public class SearchReceiptDialog extends JDialog implements ActionListener {
	...
	public SearchReceiptDialog(JFrame owner, String title, Connection conn, long sessionid,String[] kolom,String orderby,ReceiverLoader loader,String type){
	...
	class ReceiptListTable extends JTable {
		private static final long serialVersionUID = 1L;
		...
		void setReceiptList(Object[] object) {
			...
			for(int i = 0; i < object.length; i ++) {   
				GeneralReceipt Receive = (GeneralReceipt)object[i];
				model.addRow(new Object[]{
						new Integer(i + 1),
						m_type,
						Receive.vgetReceiptNo(),
						Receive.vgetReceiptDate(),
						Receive.vgetReceiveFrom(),
						Receive.vgetReceiveAccount(),
						Receive.vgetUnitCode(),
						Receive.vgetStatus(),
						Receive.vgetSubmittedDate()    					
				});
			}    
		}
		public TableCellEditor getCellEditor(int row, int col) {
