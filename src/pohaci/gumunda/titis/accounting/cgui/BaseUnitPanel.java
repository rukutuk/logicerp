...
public class BaseUnitPanel extends JPanel implements ActionListener {
	...
	public BaseUnitPanel(Connection conn, long sessionId) {
		setSize(400, 120);
		m_conn = conn;
	...
	public void constructComponent(){
		...
		this.m_unitPanel.setPreferredSize(new Dimension(200,40));
		...
		add(this.m_mergePanel, BorderLayout.CENTER);
	}
