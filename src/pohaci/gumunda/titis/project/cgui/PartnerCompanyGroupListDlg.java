...
public class PartnerCompanyGroupListDlg extends JDialog implements ActionListener {
  /**
	 * 
	 */
...
Connection m_conn = null;
  ...
  public PartnerCompanyGroupListDlg(JFrame owner, Connection conn, long sessionid) {
  ...
  void initData() {
    try {
      ...
      m_list.setListData(logic.getAllPartnerCompanyGroup(m_sessionid, IDBConstants.MODUL_MASTER_DATA));
    }
    catch(Exception ex) {
