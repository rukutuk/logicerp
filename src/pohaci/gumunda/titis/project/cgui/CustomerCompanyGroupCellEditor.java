...
public class CustomerCompanyGroupCellEditor extends DefaultCellEditor implements ActionListener {
  /**
	 * 
	 */
...
JFrame m_owner;
  ...
  public CustomerCompanyGroupCellEditor(JFrame owner, Connection conn, long sessionid) {
  ...
  public void actionPerformed(ActionEvent e) {
    if(e.getSource() == m_broweBt){
      ...
      CustomerCompanyGroupListDlg dlg = new CustomerCompanyGroupListDlg(m_owner, m_conn, m_sessionid);
      dlg.setVisible(true);
