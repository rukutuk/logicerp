...
public class SearchProjectClientContactDetailDlg extends SearchProjectClientContactDlg {
  /**
	 * 
	 */
...
PersonalTable m_detailtable;
  ...
  public SearchProjectClientContactDetailDlg(JFrame owner, Connection conn, long sessionid, ProjectData project) {
    super(owner, null, conn, sessionid, project);
    setModal(true);
    setSize(450, 600);
    find();
  }
