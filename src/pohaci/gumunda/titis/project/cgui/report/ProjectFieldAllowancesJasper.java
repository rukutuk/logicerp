...
public class ProjectFieldAllowancesJasper {	
	
	public ProjectFieldAllowancesJasper(RptFieldAllowances panel, EmployeeTimesheet[] employeeTimesheet,
		...
		try {
			...
			if(cekExcel){
				...
				view.setTitle("Field Allowances");
