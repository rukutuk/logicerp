...
public class HRMPayrollOtherAllowanceJasper {
		
	public HRMPayrollOtherAllowanceJasper(PayrollOtherAllowanceSubmitPanel panel,
		  PayrollComponent[] payrollComponents, EmployeePayroll empPayroll,EmployeePayrollSubmit[] empPayrollSubmits,
		  Employee_n[] emps, Unit unit,PayrollComponent[] payrollComponentsDefault,boolean cekExcel) {		
		
	    try {
	      String filename = "RptPayrollOtherAllowance.jrxml";
	      if(filename.equals(""))
	        return;      
	      ...
	      tableHeader(model);	       
	      PayrollOtherAllowancoLogic logic = new PayrollOtherAllowancoLogic(panel,empPayroll,model,emps,
	    		  payrollComponents,unit,empPayrollSubmits,payrollComponentsDefault,cekExcel);
	      logic.createReportBody(this);
	      ...
	      if(cekExcel){
	        ...
	        view.setTitle("Other Allowances Summary");
	...
	private void tableHeader(DefaultTableModel model) {
		...
		model.addColumn("a_tunjangan_lainnya");		
	    model.addColumn("b_tunjangan_lainnya");
