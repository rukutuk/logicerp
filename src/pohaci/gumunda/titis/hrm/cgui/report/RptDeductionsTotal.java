...
public class RptDeductionsTotal{
	JRViewer m_jrv;
	Connection m_conn;
	long m_sessionid;  
	Employee m_employee;
	...
	int m_total = 0;
	public RptDeductionsTotal(Connection conn,long sessionid,int tot) {
		try {
			m_sessionid = sessionid;
			m_conn = conn;			
			m_formatDesimal = new DecimalFormat("#,##0.00");
			String filename = "RptDeductionsTotal.jrxml";			
			if(filename.equals(""))
				return;      
