...
public class HRMPayrollInsuranceJasper extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public PayrollInsuranceAllowanceSubmitPanel m_panel;
	PayrollInsuranceAllowanceLogic m_logic;	
	public HRMPayrollInsuranceJasper(PayrollInsuranceAllowanceSubmitPanel panel,
		  PayrollComponent[] payrollComponents,  Employee_n[] emps,
		  Unit unit,EmployeePayrollSubmit[] employeePaySubm,PayrollComponent[] payrollComponentsDefault,
		  boolean cekExcel) {
		m_panel = panel;
	  try {
      String filename = "RptPayrollInsuranceAllowances.jrxml";
      if(filename.equals(""))
        return;          
      ...
      tableHeader(model);
      m_logic = new PayrollInsuranceAllowanceLogic(m_panel,panel.createEmpPayroll(),model,emps,payrollComponents,unit,
    		  employeePaySubm,payrollComponentsDefault,cekExcel);  	
      m_logic.createReportBody();
      ...
      if(cekExcel){
	        ...
	        view.setTitle("Insurance Allowances");
...
private void tableHeader(DefaultTableModel model) {
	model.addColumn("Unit");
      ...
      model.addColumn("A_TAsuransi");
      model.addColumn("B_TAsuransi");
